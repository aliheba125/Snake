...
| Q2 | Can a valid Entry Key be generated offline? | ❓ Unknown (⬜ not achieved) | depends on Q1 + Q3; symmetric ⇒ not asymmetric-hard, but inputs unknown |
...
| Q7 | What does the in-game functionality provide? | ⬜ Not Started | target games not installed in the emulator |
...
- The most important open item (Q1/Q2) is **explicitly not solved**. Understanding the beacon does
  not imply the ability to generate an Entry Key.
