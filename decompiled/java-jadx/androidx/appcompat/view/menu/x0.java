...
public class x0 implements ky0 {
    public final int a;
    public final int b;
    public final int c;
    ...
    public x0(Context context, int i, int i2, int i3, int i4, CharSequence charSequence) {
        this.l = context;
        this.a = i2;
        this.b = i;
        this.c = i4;
