...
public class zv extends aw {
    ...
    public class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                zv.this.D(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                zv.this.D(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                zv.this.D(obj3, this.f, null);
            }
        }
    }
    ...
    public static boolean C(Transition transition) {
        return (aw.l(transition.getTargetIds()) && aw.l(transition.getTargetNames()) && aw.l(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(Object obj, ArrayList arrayList) {
        ...
        if (C(transition) || !aw.l(transition.getTargets())) {
            return;
        }
    ...
    public void z(Object obj, View view, ArrayList arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            aw.f(targets, (View) arrayList.get(i));
        }
        targets.add(view);
        arrayList.add(view);
