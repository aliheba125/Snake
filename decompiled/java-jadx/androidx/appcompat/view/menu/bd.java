...
public abstract class bd {
    ...
    public static ColorStateList d(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray g = g(resources2, theme, attributeSet, in0.b);
                int resourceId = g.getResourceId(in0.c, -1);
                if (resourceId == -1 || e(resources2, resourceId)) {
                    color = g.getColor(in0.c, -65281);
                } else {
                    try {
                ...
                float f = 1.0f;
                if (g.hasValue(in0.d)) {
                    f = g.getFloat(in0.d, 1.0f);
                } else if (g.hasValue(in0.f)) {
                    f = g.getFloat(in0.f, 1.0f);
                }
                float f2 = (Build.VERSION.SDK_INT < 31 || !g.hasValue(in0.e)) ? g.getFloat(in0.g, -1.0f) : g.getFloat(in0.e, -1.0f);
                g.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != xl0.a && attributeNameResource != xl0.b) {
                        int i5 = i3 + 1;
                ...
                iArr2 = iy.a(iArr2, i2, f(color, f, f2));
                iArr = (int[][]) iy.b(iArr, i2, trimStateSet);
                i2++;
            }
            i = 1;
    ...
    public static boolean e(Resources resources, int i) {
        TypedValue c = c();
    ...
    public static int f(int i, float f, float f2) {
        boolean z = f2 >= 0.0f && f2 <= 100.0f;
        if (f == 1.0f && !z) {
            return i;
        }
        int b = ub0.b((int) ((Color.alpha(i) * f) + 0.5f), 0, 255);
        if (z) {
            r9 c = r9.c(i);
            i = r9.m(c.j(), c.i(), f2);
        }
