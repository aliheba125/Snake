...
public class FlutterJNI {
    ...
    private qk deferredComponentManager;
    private t90 localizationPlugin;
    private Long nativeShellHolderId;
    private ii0 platformMessageHandler;
    private bj0 platformViewsController;
    private ReentrantReadWriteLock shellHolderLock = new ReentrantReadWriteLock();
    private final Set<a.b> engineLifecycleListeners = new CopyOnWriteArraySet();
    private final Set<iu> flutterUiDisplayListeners = new CopyOnWriteArraySet();
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j) {
        try {
            return ImageDecoder.decodeBitmap(ImageDecoder.createSource(byteBuffer), new ImageDecoder.OnHeaderDecodedListener() { // from class: androidx.appcompat.view.menu.qt
            ...
            ea0.c(TAG, "Failed to decode image", e);
            return null;
        }
    }
    ...
    private void handlePlatformMessageResponse(int i, ByteBuffer byteBuffer) {
        ii0 ii0Var = this.platformMessageHandler;
        if (ii0Var != null) {
            ii0Var.c(i, byteBuffer);
        }
    }
    ...
    public void addIsDisplayingFlutterUiListener(iu iuVar) {
        ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.add(iuVar);
    }
    ...
    public FlutterOverlaySurface createOverlaySurface() {
        ensureRunningOnMainThread();
        bj0 bj0Var = this.platformViewsController;
        if (bj0Var != null) {
            return bj0Var.A();
        }
    ...
    public void dispatchEmptyPlatformMessage(String str, int i) {
        ...
        ea0.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i);
    }
    ...
    public void dispatchPlatformMessage(String str, ByteBuffer byteBuffer, int i, int i2) {
        ...
        ea0.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i2);
    }
    ...
    public void dispatchSemanticsAction(int i, a.g gVar) {
    ...
    public float getScaledFontSize(float f, int i) {
        DisplayMetrics b2 = qt0.b(i);
        if (b2 != null) {
            return TypedValue.applyDimension(2, f, b2) / b2.density;
        }
        ea0.b(TAG, "getScaledFontSize called with configurationId " + String.valueOf(i) + ", which can't be found.");
        return -1.0f;
    }
    ...
    public void init(Context context, String[] strArr, String str, String str2, String str3, long j) {
        if (initCalled) {
            ea0.g(TAG, "FlutterJNI.init called more than once");
        }
    ...
    public void invokePlatformMessageEmptyResponseCallback(int i) {
        ...
        try {
            if (isAttached()) {
                ...
                ea0.g(TAG, "Tried to send a platform message response, but FlutterJNI was detached from native C++. Could not send. Response ID: " + i);
            }
    ...
    public void loadLibrary() {
        if (loadLibraryCalled) {
            ea0.g(TAG, "FlutterJNI.loadLibrary called more than once");
        }
    ...
    public void onDisplayPlatformView(int i, int i2, int i3, int i4, int i5, int i6, int i7, FlutterMutatorsStack flutterMutatorsStack) {
        ...
        bj0Var.V(i, i2, i3, i4, i5, i6, i7, flutterMutatorsStack);
    }
    ...
    public void onFirstFrame() {
        ensureRunningOnMainThread();
        Iterator<iu> it = this.flutterUiDisplayListeners.iterator();
        while (it.hasNext()) {
            it.next().f();
        }
    }
    ...
    public void prefetchDefaultFontManager() {
        if (prefetchDefaultFontManagerCalled) {
            ea0.g(TAG, "FlutterJNI.prefetchDefaultFontManager called more than once");
        }
    ...
    public void removeIsDisplayingFlutterUiListener(iu iuVar) {
        ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.remove(iuVar);
    }

    public void requestDartDeferredLibrary(int i) {
        ea0.b(TAG, "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components.");
    }
    ...
    public void setDeferredComponentManager(qk qkVar) {
        ensureRunningOnMainThread();
        if (qkVar != null) {
            qkVar.a(this);
        }
    ...
    public void setLocalizationPlugin(t90 t90Var) {
        ensureRunningOnMainThread();
        this.localizationPlugin = t90Var;
    }

    public void setPlatformMessageHandler(ii0 ii0Var) {
        ensureRunningOnMainThread();
        this.platformMessageHandler = ii0Var;
    }

    public void setPlatformViewsController(bj0 bj0Var) {
        ensureRunningOnMainThread();
        this.platformViewsController = bj0Var;
    }
    ...
    public FlutterJNI spawn(String str, String str2, String str3, List<String> list) {
        ...
        pj0.a((l == null || l.longValue() == 0) ? false : true, "Failed to spawn new JNI connected shell from existing shell.");
        return nativeSpawn;
    }
    ...
    public void dispatchSemanticsAction(int i, a.g gVar, Object obj) {
        ByteBuffer byteBuffer;
        int i2;
        ensureAttachedToNative();
        if (obj != null) {
            byteBuffer = pw0.a.a(obj);
            i2 = byteBuffer.position();
        } else {
            byteBuffer = null;
            i2 = 0;
        }
        dispatchSemanticsAction(i, gVar.m, byteBuffer, i2);
    }
