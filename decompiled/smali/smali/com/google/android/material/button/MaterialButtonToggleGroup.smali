...
.method static constructor <clinit>()V
    ...
    sget v0, Landroidx/appcompat/view/menu/en0;->i:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Landroidx/appcompat/view/menu/zl0;->o:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 9
    sget-object v2, Landroidx/appcompat/view/menu/ln0;->o2:[I
    ...
    .line 11
    sget p3, Landroidx/appcompat/view/menu/ln0;->s2:I
    ...
    .line 14
    sget p3, Landroidx/appcompat/view/menu/ln0;->q2:I
    ...
    .line 16
    sget p3, Landroidx/appcompat/view/menu/ln0;->r2:I
    ...
    .line 19
    sget p3, Landroidx/appcompat/view/menu/ln0;->p2:I
...
.method public static p(Landroidx/appcompat/view/menu/st0$b;Lcom/google/android/material/button/MaterialButtonToggleGroup$c;)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/st0$b;->o(F)Landroidx/appcompat/view/menu/st0$b;

    return-void

    :cond_0
    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->a:Landroidx/appcompat/view/menu/gh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/st0$b;->B(Landroidx/appcompat/view/menu/gh;)Landroidx/appcompat/view/menu/st0$b;

    move-result-object p0

    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->d:Landroidx/appcompat/view/menu/gh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/st0$b;->t(Landroidx/appcompat/view/menu/gh;)Landroidx/appcompat/view/menu/st0$b;

    move-result-object p0

    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->b:Landroidx/appcompat/view/menu/gh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/st0$b;->F(Landroidx/appcompat/view/menu/gh;)Landroidx/appcompat/view/menu/st0$b;

    move-result-object p0

    iget-object p1, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->c:Landroidx/appcompat/view/menu/gh;

    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/st0$b;->x(Landroidx/appcompat/view/menu/gh;)Landroidx/appcompat/view/menu/st0$b;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/button/MaterialButton;->getShapeAppearanceModel()Landroidx/appcompat/view/menu/st0;
    ...
    invoke-direct {v0, v1, v2, v3, p2}, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;-><init>(Landroidx/appcompat/view/menu/gh;Landroidx/appcompat/view/menu/gh;Landroidx/appcompat/view/menu/gh;Landroidx/appcompat/view/menu/gh;)V
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/view/menu/m51;->k0(Landroid/view/View;Landroidx/appcompat/view/menu/b0;)V
...
.method public final c()V
    ...
    invoke-static {v4, v6}, Landroidx/appcompat/view/menu/fb0;->c(Landroid/view/ViewGroup$MarginLayoutParams;I)V

    neg-int v3, v3

    invoke-static {v4, v3}, Landroidx/appcompat/view/menu/fb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
    ...
    invoke-static {v4, v6}, Landroidx/appcompat/view/menu/fb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method public final n(I)V
    ...
    :cond_1
    invoke-static {p1, v2}, Landroidx/appcompat/view/menu/fb0;->c(Landroid/view/ViewGroup$MarginLayoutParams;I)V

    invoke-static {p1, v2}, Landroidx/appcompat/view/menu/fb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/view/menu/p0;->C0(Landroid/view/accessibility/AccessibilityNodeInfo;)Landroidx/appcompat/view/menu/p0;
    ...
    invoke-static {v2, v0, v3, v1}, Landroidx/appcompat/view/menu/p0$e;->a(IIZI)Landroidx/appcompat/view/menu/p0$e;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/p0;->e0(Ljava/lang/Object;)V
...
.method public s()V
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/google/android/material/button/MaterialButton;->getShapeAppearanceModel()Landroidx/appcompat/view/menu/st0;

    move-result-object v5

    invoke-virtual {v5}, Landroidx/appcompat/view/menu/st0;->v()Landroidx/appcompat/view/menu/st0$b;
    ...
    invoke-static {v5, v6}, Lcom/google/android/material/button/MaterialButtonToggleGroup;->p(Landroidx/appcompat/view/menu/st0$b;Lcom/google/android/material/button/MaterialButtonToggleGroup$c;)V

    invoke-virtual {v5}, Landroidx/appcompat/view/menu/st0$b;->m()Landroidx/appcompat/view/menu/st0;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/google/android/material/button/MaterialButton;->setShapeAppearanceModel(Landroidx/appcompat/view/menu/st0;)V
