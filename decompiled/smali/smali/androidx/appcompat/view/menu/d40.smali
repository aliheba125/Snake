.class public abstract Landroidx/appcompat/view/menu/d40;
...
.method public static a(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/view/menu/d40;->c(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;)[I
    ...
    invoke-static {v0, p0}, Landroidx/appcompat/view/menu/om;->i(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    goto :goto_0

    :cond_0
    invoke-static {v0, p2}, Landroidx/appcompat/view/menu/om;->i(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    :goto_0
    if-eqz p3, :cond_1

    invoke-static {v0, p3}, Landroidx/appcompat/view/menu/om;->j(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/d3;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public static d(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p2, p0}, Landroidx/appcompat/view/menu/om;->i(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/d3;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public static f(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {p0}, Landroidx/appcompat/view/menu/m51;->J(Landroid/view/View;)Z
    ...
    :goto_1
    invoke-static {p0, v2}, Landroidx/appcompat/view/menu/m51;->u0(Landroid/view/View;I)V
...
.method public static h(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnClickListener;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {p0, p2}, Landroidx/appcompat/view/menu/d40;->f(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
...
.method public static i(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/view/menu/d40;->f(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
