...
# instance fields
.field private callback:Lio/flutter/view/TextureRegistry$SurfaceProducer$a;
...
.method public static synthetic access$200(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;)Lio/flutter/view/TextureRegistry$SurfaceProducer$a;
    .locals 0
...
.method public static synthetic access$700(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;)Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer$b;
    .locals 0
...
.method private createImageReader29()Landroid/media/ImageReader;
    ...
    invoke-static/range {v0 .. v5}, Landroidx/appcompat/view/menu/mt;->a(IIIIJ)Landroid/media/ImageReader;
...
.method private createImageReader33()Landroid/media/ImageReader;
    ...
    invoke-static {}, Landroidx/appcompat/view/menu/cu;->a()V

    iget v0, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedWidth:I

    iget v1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedHeight:I

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/bu;->a(II)Landroid/media/ImageReader$Builder;

    move-result-object v0

    const/4 v1, 0x5

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/vt;->a(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const/16 v1, 0x22

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/wt;->a(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const-wide/16 v1, 0x100

    invoke-static {v0, v1, v2}, Landroidx/appcompat/view/menu/xt;->a(Landroid/media/ImageReader$Builder;J)Landroid/media/ImageReader$Builder;

    invoke-static {v0}, Landroidx/appcompat/view/menu/yt;->a(Landroid/media/ImageReader$Builder;)Landroid/media/ImageReader;
...
.method private maybeWaitOnFence(Landroid/media/Image;)V
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/view/menu/ea0;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private releaseInternal()V
    ...
    invoke-static {v0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)Ljava/util/List;
...
.method private waitOnFence(Landroid/media/Image;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/view/menu/zt;->a(Landroid/media/Image;)Landroid/hardware/SyncFence;

    move-result-object p1

    invoke-static {p1}, Landroidx/appcompat/view/menu/au;->a(Landroid/hardware/SyncFence;)Z
    :try_end_0
...
.method public finalize()V
    ...
    invoke-static {v0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->e(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)Landroid/os/Handler;
    ...
    invoke-static {v4}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->d(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)Lio/flutter/embedding/engine/FlutterJNI;
...
.method public getOrCreatePerImageReader(Landroid/media/ImageReader;)Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer$b;
    .locals 2
...
.method public onImage(Landroid/media/ImageReader;Landroid/media/Image;)V
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->f(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
...
.method public scheduleFrame()V
    ...
    invoke-static {v0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->f(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
