...
.field private deferredComponentManager:Landroidx/appcompat/view/menu/qk;
...
.field private final flutterUiDisplayListeners:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Landroidx/appcompat/view/menu/iu;",
            ">;"
        }
    .end annotation
.end field

.field private localizationPlugin:Landroidx/appcompat/view/menu/t90;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Landroidx/appcompat/view/menu/ii0;

.field private platformViewsController:Landroidx/appcompat/view/menu/bj0;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    new-instance v0, Landroidx/appcompat/view/menu/qt;

    invoke-direct {v0, p1, p2}, Landroidx/appcompat/view/menu/qt;-><init>(J)V
    ...
    invoke-static {p1, p2, p0}, Landroidx/appcompat/view/menu/ea0;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Landroidx/appcompat/view/menu/ii0;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Landroidx/appcompat/view/menu/ii0;->c(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Landroidx/appcompat/view/menu/iu;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/t90;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/t90;

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/t90;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/bj0;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/bj0;->A()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Landroidx/appcompat/view/menu/ea0;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/a$g;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-virtual {p0, p1, p2, v0}, Lio/flutter/embedding/engine/FlutterJNI;->dispatchSemanticsAction(ILio/flutter/view/a$g;Ljava/lang/Object;)V

    return-void
.end method

.method public dispatchSemanticsAction(ILio/flutter/view/a$g;Ljava/lang/Object;)V
    .locals 1
    ...
    .line 3
    sget-object v0, Landroidx/appcompat/view/menu/pw0;->a:Landroidx/appcompat/view/menu/pw0;

    invoke-virtual {v0, p3}, Landroidx/appcompat/view/menu/pw0;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    .line 5
    :goto_0
    iget p2, p2, Lio/flutter/view/a$g;->m:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Landroidx/appcompat/view/menu/qt0;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Landroidx/appcompat/view/menu/ii0;->d(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/bj0;->S()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/view/menu/bj0;->U(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/bj0;
    ...
    invoke-virtual/range {v1 .. v9}, Landroidx/appcompat/view/menu/bj0;->V(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/bj0;->W()V
...
.method public removeIsDisplayingFlutterUiListener(Landroidx/appcompat/view/menu/iu;)V
    .locals 1
...
.method public setDeferredComponentManager(Landroidx/appcompat/view/menu/qk;)V
    .locals 0
    ...
    invoke-interface {p1, p0}, Landroidx/appcompat/view/menu/qk;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Landroidx/appcompat/view/menu/t90;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/t90;

    return-void
.end method

.method public setPlatformMessageHandler(Landroidx/appcompat/view/menu/ii0;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Landroidx/appcompat/view/menu/ii0;

    return-void
.end method

.method public setPlatformViewsController(Landroidx/appcompat/view/menu/bj0;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/bj0;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Landroidx/appcompat/view/menu/pj0;->a(ZLjava/lang/Object;)V
