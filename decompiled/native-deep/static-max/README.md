...
ما يمكن استرجاعه ساكنياً — **مع التزام صارم بعدم ادّعاء أي نتيجة غير مُثبَتة**.
...
- ❌ فكّ بيانات/سلاسل فعلية ساكنياً: **غير ممكن** — البذرتان والنص المشفّر يُنتَجان وقت التشغيل
  (حقول كائن، ملفات/شبكة)، ولا يوجد زوج ثابت (بذرة+نص) في الملف. **لم تُفكّ أي سلسلة فعلية،
  ولم يُدَّعَ ذلك.**
