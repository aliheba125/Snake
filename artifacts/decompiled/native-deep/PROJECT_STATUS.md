...
## نجاح: Stalker يتجاوز watchdog (مُثبَت — 120s+ بقاء)
...
## نجاح: التقاط أحداث فعلية من libengine عبر libc hooks
...
## نجاح: التقاط DNS + connections عند بدء التطبيق (script-mode Gadget)
