...
.super Landroidx/appcompat/view/menu/l3;
.source "SourceFile"
...
# instance fields
.field public h:Landroidx/appcompat/view/menu/qc0;

.field public i:Ljava/lang/CharSequence;

.field public j:Landroid/graphics/drawable/Drawable;

.field public k:Landroidx/appcompat/view/menu/mc0$b;

.field public l:Landroidx/appcompat/view/menu/yu;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/view/menu/l3;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    sget-object v1, Landroidx/appcompat/view/menu/mn0;->t:[I
    ...
    .line 6
    sget p2, Landroidx/appcompat/view/menu/mn0;->u:I
...
.method public c()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/qc0;
...
.method public d(Landroidx/appcompat/view/menu/qc0;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/qc0;
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/qc0;->h(Landroidx/appcompat/view/menu/wc0$a;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Landroidx/appcompat/view/menu/yu;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Landroidx/appcompat/view/menu/yu;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Landroidx/appcompat/view/menu/mc0$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/qc0;

    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/mc0$b;->a(Landroidx/appcompat/view/menu/qc0;)Z
...
.method public onMeasure(II)V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroidx/appcompat/view/menu/l3;->onMeasure(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/qc0;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Landroidx/appcompat/view/menu/yu;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Landroidx/appcompat/view/menu/yu;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public s()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/l3;->getText()Ljava/lang/CharSequence;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/qc0;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroidx/appcompat/view/menu/qc0;->a()V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, Landroidx/appcompat/view/menu/l3;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/mc0$b;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Landroidx/appcompat/view/menu/mc0$b;
...
.method public final u()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/qc0;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/qc0;->A()Z
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/qc0;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/qc0;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/qc0;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :goto_4
    invoke-static {p0, v1}, Landroidx/appcompat/view/menu/f11;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    :cond_6
    invoke-static {p0, v2}, Landroidx/appcompat/view/menu/f11;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
