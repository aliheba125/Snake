...
import androidx.appcompat.view.menu.xx;
...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public final void b() {
        ...
        if (pendingIntent == null) {
            xx.m().n(this, ((Integer) mj0.i(num)).intValue(), 2, this);
            this.a = 1;
            return;
        }
        try {
            ...
            if (extras.getBoolean("notify_manager", true)) {
                ay.x(this).F(new ef(22, null), getIntent().getIntExtra("failing_client_id", -1));
            } else {
        ...
        if (i == 1) {
            ...
            if (booleanExtra) {
                ...
                if (i2 == -1) {
                    ...
                    x.F(new ef(13, null), getIntent().getIntExtra("failing_client_id", -1));
                }
            }
        } else if (i == 2) {
            this.a = 0;
