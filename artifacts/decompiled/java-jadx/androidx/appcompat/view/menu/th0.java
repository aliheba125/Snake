...
public abstract class th0 {
    ...
    public static class b {
        ...
        public static void e(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        public static void f(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            ...
            if (d19 < 0.0d) {
                ...
                f(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            double d22 = d * d6;
            double d23 = d2 * d9;
            e(path, (d22 * cos) - (d23 * sin), (d22 * sin) + (d23 * cos), d6, d9, d3, d5, radians, atan2, atan22);
        }
    ...
    public static b[] c(String str) {
        ...
        while (i2 < str.length()) {
            int g = g(str, i2);
            String trim = str.substring(i, g).trim();
            if (!trim.isEmpty()) {
