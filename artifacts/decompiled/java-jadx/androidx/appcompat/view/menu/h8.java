...
public final class h8 {
    ...
    public static final class a {
        ...
        public a() {
            c(h8.e(Locale.getDefault()));
        }

        public static h8 b(boolean z) {
            return z ? h8.h : h8.g;
        }

        public h8 a() {
            return (this.b == 2 && this.c == h8.d) ? b(this.a) : new h8(this.a, this.b, this.c);
        }
    ...
    static {
        ...
        g = new h8(false, 2, tz0Var);
        h = new h8(true, 2, tz0Var);
    }

    public h8(boolean z, int i, tz0 tz0Var) {
        this.a = z;
        this.b = i;
        this.c = tz0Var;
    }
    ...
    public final String f(CharSequence charSequence, tz0 tz0Var) {
        boolean a2 = tz0Var.a(charSequence, 0, charSequence.length());
        return (this.a || !(a2 || b(charSequence) == 1)) ? this.a ? (!a2 || b(charSequence) == -1) ? f : "" : "" : e;
    }

    public final String g(CharSequence charSequence, tz0 tz0Var) {
        boolean a2 = tz0Var.a(charSequence, 0, charSequence.length());
    ...
    public CharSequence i(CharSequence charSequence, tz0 tz0Var, boolean z) {
        ...
        if (d() && z) {
            spannableStringBuilder.append((CharSequence) g(charSequence, a2 ? uz0.b : uz0.a));
        }
        if (a2 != this.a) {
        ...
        if (z) {
            spannableStringBuilder.append((CharSequence) f(charSequence, a2 ? uz0.b : uz0.a));
        }
    ...
    public String k(String str, tz0 tz0Var, boolean z) {
        if (str == null) {
            return null;
        }
        return i(str, tz0Var, z).toString();
    }
}
