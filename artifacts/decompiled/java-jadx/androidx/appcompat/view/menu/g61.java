...
public abstract class g61 {
    ...
    public static void c(ViewParent viewParent, View view, int i, int i2, int[] iArr, int i3) {
        if (viewParent instanceof se0) {
            ((se0) viewParent).c(view, i, i2, iArr, i3);
            return;
        }
        if (i3 == 0) {
            try {
    ...
    public static void d(ViewParent viewParent, View view, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        if (viewParent instanceof te0) {
            ((te0) viewParent).d(view, i, i2, i3, i4, i5, iArr);
            return;
        }
        iArr[0] = iArr[0] + i3;
        iArr[1] = iArr[1] + i4;
        if (viewParent instanceof se0) {
            ((se0) viewParent).e(view, i, i2, i3, i4, i5);
            return;
        }
        if (i5 == 0) {
            try {
    ...
    public static void e(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof se0) {
            ((se0) viewParent).a(view, view2, i, i2);
            return;
        }
        if (i2 == 0) {
            try {
    ...
    public static boolean f(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof se0) {
            return ((se0) viewParent).f(view, view2, i, i2);
        }
        if (i2 != 0) {
            return false;
        }
