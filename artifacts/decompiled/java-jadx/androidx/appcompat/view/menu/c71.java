...
public final class c71 {
    public static final c71 k = k(s9.c, (float) ((s9.h(50.0f) * 63.66197723675813d) / 100.0d), 50.0f, 2.0f, false);
    ...
    public c71(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
    ...
    public static c71 k(float[] fArr, float f, float f2, float f3, boolean z) {
        float[][] fArr2 = s9.a;
        float f4 = fArr[0];
        float[] fArr3 = fArr2[0];
        float f5 = fArr3[0] * f4;
        ...
        float d = ((double) f12) >= 0.9d ? s9.d(0.59f, 0.69f, (f12 - 0.9f) * 10.0f) : s9.d(0.525f, 0.59f, (f12 - 0.8f) * 10.0f);
        ...
        float f16 = fArr7[0];
        float f17 = fArr7[1];
        return new c71(h, ((((f16 * 400.0f) / (f16 + 27.13f)) * 2.0f) + ((f17 * 400.0f) / (f17 + 27.13f)) + (((400.0f * pow2) / (pow2 + 27.13f)) * 0.05f)) * pow, pow, pow, d, f12, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
