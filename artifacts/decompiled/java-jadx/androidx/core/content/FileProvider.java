...
public class FileProvider extends ContentProvider {
    ...
    public static b j(Context context, String str, int i) {
        c cVar = new c(str);
        XmlResourceParser e2 = e(context, str, context.getPackageManager().resolveContentProvider(str, PackageParser.PARSE_IS_PRIVILEGED), i);
        while (true) {
            int next = e2.next();
            if (next == 1) {
                return cVar;
            ...
            if (next == 2) {
                ...
                File file = null;
                String attributeValue = e2.getAttributeValue(null, "name");
                ...
                if ("root-path".equals(name)) {
                    ...
                    File[] g2 = lg.g(context, null);
                    if (g2.length > 0) {
                        file = g2[0];
                    }
                } else if ("external-cache-path".equals(name)) {
                    File[] f2 = lg.f(context);
                    if (f2.length > 0) {
                        file = f2[0];
                    }
    ...
    public final b f() {
        ...
        synchronized (this.a) {
            try {
                yf0.d(this.b, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
                if (this.c == null) {
