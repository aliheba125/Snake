...
public class g extends RecyclerView.y {
    ...
    public int t(View view, int i) {
        ...
        return s(e.V(view) - ((ViewGroup.MarginLayoutParams) pVar).leftMargin, e.Y(view) + ((ViewGroup.MarginLayoutParams) pVar).rightMargin, e.j0(), e.u0() - e.k0(), i);
    }
    ...
    public int u(View view, int i) {
        ...
        RecyclerView.p pVar = (RecyclerView.p) view.getLayoutParams();
        return s(e.Z(view) - ((ViewGroup.MarginLayoutParams) pVar).topMargin, e.T(view) + ((ViewGroup.MarginLayoutParams) pVar).bottomMargin, e.m0(), e.b0() - e.h0(), i);
    }
