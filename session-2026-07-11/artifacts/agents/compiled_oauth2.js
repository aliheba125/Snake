  ...
  frida_java_bridge_default.enumerateClassLoaders({
    onMatch(loader) {
      ...
      try {
        ...
        found = true;
        send(`${T()} Native found`);
        const vx = frida_java_bridge_default.use("androidx.appcompat.view.menu.vx");
        const Long = frida_java_bridge_default.use("java.lang.Long");
        try {
          vx.c.overload("long", "int", "java.lang.String", "java.lang.String", "java.lang.String", "boolean").call(vx, 12345678, 0, "117283946502837465", "eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiIxMTcyODM5NDY1MDI4Mzc0NjUiLCJlbWFpbCI6InRlc3RAZ21haWwuY29tIn0.fake", "", false);
          send(`${T()} vx.c() SUCCESS`);
        } catch (e) {
          send(`${T()} vx.c() err: ${e}`);
          try {
            Native.logIn.overload("java.lang.String", "long").call(Native, "918010152455-tbk8ajicdmlqntolgea1vtlrc94nip3p.apps.googleusercontent.com", 99999);
            send(`${T()} logIn() called`);
          } catch (e2) {
            send(`${T()} logIn err: ${e2}`);
          }
