  ...
  frida_java_bridge_default.enumerateClassLoaders({
    onMatch(loader) {
      ...
      try {
        ...
        try {
          vx.c(frida_java_bridge_default.use("java.lang.Long").$new(12345678), 0, fakeSub, fakeJWT, "", false);
        ...
        try {
          ...
          Native.logIn(clientId, frida_java_bridge_default.use("java.lang.Long").$new(Date.now()));
