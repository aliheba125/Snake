...
var t0 = Date.now();
function T() {
  return `[+${((Date.now() - t0) / 1e3).toFixed(1)}s]`;
}
  ...
  frida_java_bridge_default.enumerateClassLoaders({
    onMatch(loader) {
      if (found)
        return;
      try {
        frida_java_bridge_default.classFactory.loader = loader;
        const Native = frida_java_bridge_default.use("com.snake.helper.Native");
        found = true;
        send(`${T()} Native class found \u2014 installing all hooks`);
        Native.pjowqpxe.overload("java.lang.Object", "java.lang.Object", "java.lang.Object").implementation = function(a, b, c) {
          ...
          if (typeof a === "string" || a && a.toString)
            send(`    a=${a.toString().substring(0, 200)}`);
          if (typeof b === "string" || b && b.toString)
            send(`    b=${b.toString().substring(0, 200)}`);
          if (typeof c === "string" || c && c.toString)
            send(`    c=${c.toString().substring(0, 200)}`);
          return this.pjowqpxe(a, b, c);
        };
        Native.aior.overload("java.lang.String", "java.lang.String").implementation = function(s1, s2) {
          send(`${T()} >>> aior("${s1}", "${s2}")`);
          return this.aior(s1, s2);
        };
        Native.awl.overload("java.lang.String").implementation = function(s) {
          send(`${T()} >>> awl("${s}")`);
          return this.awl(s);
        };
        Native.ic.overload("android.content.Context").implementation = function(ctx) {
          send(`${T()} >>> ic(${ctx.getPackageName()})`);
          return this.ic(ctx);
        };
        Native.update.overload("java.lang.Object", "java.lang.reflect.Method").implementation = function(obj, method) {
        ...
        Native.eio.overload().implementation = function() {
          send(`${T()} >>> eio()`);
          return this.eio();
        };
        Native.chl.overload("[B").implementation = function(data) {
          const result = this.chl(data);
          let hex = "";
          if (data)
            for (let i = 0; i < Math.min(data.length, 64); i++)
              hex += ("0" + (data[i] & 255).toString(16)).slice(-2);
          send(`${T()} >>> chl(${data ? data.length : 0}B) => ${result} hex=${hex}`);
          return result;
        };
        try {
          Native.i.overload("int").implementation = function(v) {
            send(`${T()} >>> i(${v})`);
            return this.i(v);
          };
        } catch (e) {
        ...
        try {
          Native.gcuid.overload("int").implementation = function(v) {
        ...
        try {
          Native.ac.overload().implementation = function() {
            send(`${T()} >>> ac()`);
            return this.ac();
          };
        } catch (e) {
